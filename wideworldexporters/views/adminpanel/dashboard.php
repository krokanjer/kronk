...
<head>
    <?php include($_SERVER['DOCUMENT_ROOT'] . '/wideworldexporters/controller/adminpanel/dashboard.php'); ?>
    <meta charset="utf-8">
                            ...
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $user_amount ?></div>
                                    </div>
                                    <div class="col-auto">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-primary"
                   href="<?php $_SERVER['DOCUMENT_ROOT'] ?>/wideworldexporters/views/login.php">Logout</a>
            </div>
        </div>
    </div>
</div>
...
<!-- Page level plugins -->
<script src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/wideworldexporters/vendor/chart.js/Chart.min.js"></script>

<!-- Page level custom scripts -->
<script src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/wideworldexporters/js/demo/chart-area-demo.js"></script>
<script src="<?php $_SERVER['DOCUMENT_ROOT'] ?>/wideworldexporters/js/demo/chart-pie-demo.js"></script>
